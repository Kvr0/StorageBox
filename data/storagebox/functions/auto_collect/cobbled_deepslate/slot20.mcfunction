#> storagebox:auto_collect/cobbled_deepslate/slot20
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:20b}].Count 1
