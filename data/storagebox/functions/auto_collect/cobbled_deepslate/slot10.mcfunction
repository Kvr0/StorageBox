#> storagebox:auto_collect/cobbled_deepslate/slot10
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:10b}].Count 1
