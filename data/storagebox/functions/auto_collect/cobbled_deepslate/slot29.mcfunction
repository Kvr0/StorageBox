#> storagebox:auto_collect/cobbled_deepslate/slot29
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:29b}].Count 1
