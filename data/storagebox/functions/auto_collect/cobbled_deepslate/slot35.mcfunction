#> storagebox:auto_collect/cobbled_deepslate/slot35
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:35b}].Count 1
