#> storagebox:auto_collect/cobbled_deepslate/slot24
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:24b}].Count 1
