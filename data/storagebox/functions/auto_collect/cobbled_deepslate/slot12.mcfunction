#> storagebox:auto_collect/cobbled_deepslate/slot12
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:12b}].Count 1
