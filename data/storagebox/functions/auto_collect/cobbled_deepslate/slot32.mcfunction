#> storagebox:auto_collect/cobbled_deepslate/slot32
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:32b}].Count 1
