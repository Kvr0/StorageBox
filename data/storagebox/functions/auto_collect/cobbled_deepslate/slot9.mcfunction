#> storagebox:auto_collect/cobbled_deepslate/slot9
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:9b}].Count 1
