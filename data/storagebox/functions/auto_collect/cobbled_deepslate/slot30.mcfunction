#> storagebox:auto_collect/cobbled_deepslate/slot30
...
execute store result score $storagebox:auto_collect/cobbled_deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:30b}].Count 1
