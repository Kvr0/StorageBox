#> storagebox:auto_collect/deepslate/slot35
...
execute store result score $storagebox:auto_collect/deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:35b}].Count 1
