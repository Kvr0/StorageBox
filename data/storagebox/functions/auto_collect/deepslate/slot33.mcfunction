#> storagebox:auto_collect/deepslate/slot33
...
execute store result score $storagebox:auto_collect/deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:33b}].Count 1
