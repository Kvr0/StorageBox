#> storagebox:auto_collect/deepslate/slot22
...
execute store result score $storagebox:auto_collect/deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:22b}].Count 1
