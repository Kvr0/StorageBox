#> storagebox:auto_collect/deepslate/slot16
...
execute store result score $storagebox:auto_collect/deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:16b}].Count 1
