#> storagebox:auto_collect/deepslate/slot13
...
execute store result score $storagebox:auto_collect/deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:13b}].Count 1
