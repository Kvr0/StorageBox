...
s = '''#> storagebox:auto_collect/deepslate/slot{0}
...
execute store result score $storagebox:auto_collect/deepslate/*.count temporary run data get storage calculation: storagebox.inventory[{{Slot:{0}b}}].Count 1
