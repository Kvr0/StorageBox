#> storagebox:auto_collect/cobblestone/slot20
...
execute store result score $storagebox:auto_collect/cobblestone/*.count temporary run data get storage calculation: storagebox.inventory[{Slot:20b}].Count 1
